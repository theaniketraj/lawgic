  ...
  return (
    ...
    >
      <div className="flex items-center justify-center min-h-screen p-4">
        ...
        <div
          className={cn(
            "bg-white dark:bg-gray-900 rounded-3xl text-left overflow-hidden sm:w-147.5 transform transition-all p-5 sm:p-12 relative",
            className?.modal,
          )}
        >
          ...
          <div className="mt-3 text-left w-full">
            <h3 className="text-[30px] mb-2 leading-9.5 font-bold text-gray-800 dark:text-white/90">
              {title}
            </h3>
            {description && (
