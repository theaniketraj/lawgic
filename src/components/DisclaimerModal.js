      ...
      <div className="disclaimer-modal">
        ...
        <div className="disclaimer-content">
          ...
          <ul className="disclaimer-list">
            <li>
              <strong>Not Legal Advice:</strong> The information provided by this chatbot does not constitute legal advice, and it should not be treated as such.
            </li>
            <li>
            ...
            <li>
              <strong>Accuracy:</strong> While we strive for accuracy, laws and regulations (especially in India regarding BNS, BNSS, and BSA) change frequently. Always verify details with a qualified legal professional.
            </li>
            <li>
