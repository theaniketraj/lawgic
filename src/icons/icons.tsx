...
export function TextGeneratorIcon({ className = '' }: Readonly<{ className?: string }>) {
  return (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
...
export function ImageGeneratorIcon({ className = '' }: Readonly<{ className?: string }>) {
  return (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
...
export function CodeGeneratorIcon({ className = '' }: Readonly<{ className?: string }>) {
  return (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
...
export function VideoGeneratorIcon({ className = '' }: Readonly<{ className?: string }>) {
  return (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
...
export function EmailGeneratorIcon({ className = '' }: Readonly<{ className?: string }>) {
  return (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
...
export function MoreVerticalIcon({ className = '' }: Readonly<{ className?: string }>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="18"
...
export function ClipboardIcon(props: Readonly<IconProps>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="18"
...
export function ThumbsUpIcon(props: Readonly<IconProps>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="18"
...
export function CheckMarkIcon(props: Readonly<IconProps>) {
  return (
    <svg
      width={24}
      height={24}
...
export function PencilIcon(props: Readonly<IconProps>) {
  return (
    <svg
      width={24}
      height={24}
...
export function LongArrowUpIcon(props: Readonly<IconProps>) {
  return (
    <svg
      width={20}
      height={20}
...
export function AttachmentIcon(props: Readonly<IconProps>) {
  return (
    <svg
      width={20}
      height={20}
...
export function ChevronDown2Icon(props: Readonly<IconProps>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="17"
...
export function CodeXmlIcon(props: Readonly<IconProps>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="18"
...
export function CheckMarkIcon2(props: Readonly<IconProps>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="20"
...
export function ChatGPTIcon(props: Readonly<IconProps>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="30"
...
export function MidjourneyIcon(props: Readonly<IconProps>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="42"
...
export function FigmaIcon(props: Readonly<IconProps>) {
  return (
    <svg
      className="w-6 h-6"
      viewBox="0 0 24 24"
